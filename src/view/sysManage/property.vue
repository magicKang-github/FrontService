<template>
  <card style="height: 100%" >
    ...
    <Form ref="findForm" :model="searchData" :label-width="60" inline>
      ...
      <FormItem label="属性名：" prop="key">
        <Input  v-model="searchData.skey" placeholder="请输入属性名..." clearable style="width: 190px" />
      </FormItem>
      <FormItem label="描述：" prop="note">
        <Input  v-model="searchData.note" placeholder="请输入描述..." clearable style="width: 190px" />
      </FormItem>
    ...
    <Drawer title="addMode" v-model="insertMode" width="500" :mask-closable="false" :styles="styles">
      ...
      <Form ref="insertForm" :model="insertData"  :rules="submitRules" :label-width="130">
        <FormItem label="属性名" prop="skey">
          <Input v-model="insertData.skey" placeholder="请输入属性名..." style="width:250px" />
        </FormItem>
        <FormItem label="属性值" prop="value">
          <Input v-model="insertData.value" placeholder="请输入属性值..." style="width:250px" />
        </FormItem>
        <FormItem label="属性描述" prop="note" >
          <Input type="textarea" v-model="insertData.note" :rows="4" placeholder="请输入属性描述..." style="width:250px" />
        </FormItem>
        <FormItem label="状态：" prop="status" >
    ...
    <Drawer title="updateMode" v-model="modifyMode" width="500" :mask-closable="false" :styles="styles">
      ...
      <Form ref="updateForm" :model="updateData"  :rules="submitRules" :label-width="130">
        ...
        <FormItem label="属性名" prop="skey">
          <Input v-model="updateData.skey" placeholder="请输入属性名..." style="width:250px" />
        </FormItem>
        <FormItem label="属性值" prop="value">
          <Input v-model="updateData.value" placeholder="请输入属性值..." style="width:250px" />
        </FormItem>
        <FormItem label="属性描述" prop="note" >
          <Input type="textarea" v-model="updateData.note" :rows="4" placeholder="请输入属性描述..." style="width:250px" />
        </FormItem>
        <FormItem label="状态：" prop="status" >
...
export default {
  ...
  methods: {
    ...mapGetters('property', []),
    ...mapMutations('property', ['selection']),
    ...mapActions('property', ['findDataAction', 'insertFormData', 'updateFormData', 'getModifyData', 'deleteFormData']),
    handleSubmit (name) {
