  ...
  <Card shadow>
    <div>
      ...
      <div class="message-page-con message-view-con">
        ...
        <div v-if="isShowingMsgItem" style="margin-bottom: 20px;">
          <h4>
            <span style="margin-left: 5px;">用户：</span><span style="font-style: italic; color: rgb(194, 79, 74);">{{ showingMsgItem.name }}</span>
            <span style="margin-left: 20px;">手机号：</span><span style="font-style: italic; color: rgb(194, 79, 74);">{{ showingMsgItem.phone }}</span>
            <span style="margin-left: 20px;">邮箱：</span><span style="font-style: italic; color: rgb(194, 79, 74);">{{ showingMsgItem.email }}</span>
          </h4>
        </div>
