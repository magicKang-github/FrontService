...
export default {
  ...
  methods: {
    ...mapGetters('productGauze', []),
    ...mapMutations('productGauze', ['selection']),
    ...mapActions('productGauze', ['findDataAction', 'insertFormData', 'updateFormData', 'getModifyData', 'deleteFormData']),
    handleSubmit (name) {
