  ...
  <card style="height: 100%" >
    ...
    <Drawer title="addMode" v-model="insertMode" width="500" :mask-closable="false" :styles="styles">
      ...
      <Form ref="insertForm" :model="insertData"  :rules="submitRules" :label-width="130">
        <FormItem label="类型名称" prop="name">
          <Input v-model="insertData.name" placeholder="请输入类型名称..." style="width:310px" />
        </FormItem>
        <FormItem label="类型简介" prop="note" >
          <Input type="textarea" v-model="insertData.note" :rows="4" placeholder="请输入类型简介..." style="width:310px" />
        </FormItem>
        <FormItem label="类型图片" prop="images" >
    ...
    <Drawer title="updateMode" v-model="modifyMode" width="500" :mask-closable="false" :styles="styles">
      ...
      <Form ref="updateForm" :model="updateData"  :rules="submitRules" :label-width="130">
        ...
        <FormItem label="类型名称" prop="name">
          <Input v-model="updateData.name" placeholder="请输入类型名称..." style="width:310px" />
        </FormItem>
        <FormItem label="类型图片" prop="images" >
          <upload-pic-input :defaultImages="updateData.images" placeholder="请输入图片路径..." @on-change="handleUpload" width="200px" ref="upload"></upload-pic-input>
        </FormItem>
        <FormItem label="类型简介" prop="note" >
          <Input type="textarea" v-model="updateData.note" :rows="4" placeholder="请输入类型简介..." style="width:310px" />
        </FormItem>
        <FormItem label="类型状态：" prop="status" >
...
export default {
  ...
  methods: {
    ...
    ...mapMutations('productType', ['selection']),
    ...mapActions('productType', ['findDataAction', 'insertFormData', 'updateFormData', 'getModifyData', 'deleteFormData']),
    handleSubmit (name) {
