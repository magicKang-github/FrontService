  ...
  <card style="height: 100%" >
    ...
    <Form ref="findForm" :model="searchData" :label-width="60" inline>
      ...
      <FormItem label="标签名：" prop="name">
        <Input  v-model="searchData.name" placeholder="请输入标签名..." clearable style="width: 190px" />
      </FormItem>
      <FormItem label="简介：" prop="note">
        <Input  v-model="searchData.note" placeholder="请输入简介..." clearable style="width: 190px" />
      </FormItem>
    ...
    <Drawer title="addMode" v-model="insertMode" width="500" :mask-closable="false" :styles="styles">
      ...
      <Form ref="insertForm" :model="insertData"  :rules="submitRules" :label-width="130">
        <FormItem label="标签名称" prop="name">
          <Input v-model="insertData.name" placeholder="请输入标签名称..." style="width:250px" />
        </FormItem>
        <FormItem label="标签简介" prop="note" >
          <Input type="textarea" v-model="insertData.note" :rows="4" placeholder="请输入标签简介..." style="width:250px" />
        </FormItem>
        <FormItem label="状态：" prop="status" >
    ...
    <Drawer title="updateMode" v-model="modifyMode" width="500" :mask-closable="false" :styles="styles">
      ...
      <Form ref="updateForm" :model="updateData"  :rules="submitRules" :label-width="130">
        ...
        <FormItem label="标签名称" prop="name">
          <Input v-model="updateData.name" placeholder="请输入标签名称..." style="width:250px" />
        </FormItem>
        <FormItem label="标签简介" prop="note" >
...
export default {
  ...
  methods: {
    ...mapGetters('productTag', []),
    ...mapMutations('productTag', ['selection']),
    ...mapActions('productTag', ['findDataAction', 'insertFormData', 'updateFormData', 'getModifyData', 'deleteFormData']),
    handleSubmit (name) {
