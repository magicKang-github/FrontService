...
export default {
  ...
  methods: {
    ...mapGetters('productPart', []),
    ...mapMutations('productPart', ['selection']),
    ...mapActions('productPart', ['findDataAction', 'insertFormData', 'updateFormData', 'getModifyData', 'deleteFormData']),
    handleSubmit (name) {
